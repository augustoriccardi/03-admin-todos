...
export const ItemCard = ({ product, quantity }: Props) => {
  ...
  return (
    <div className="flex items-center shadow rounded-lg w-full bg-white border-gray-100 dark:border-gray-100 dark:bg-black">
      {/* Product Image */}
      <div className="p-2">
        <Image
          width={200}
      ...
      <div className="px-5 pb-5 w-full flex flex-col mt-2 ">
        <a href="#">
          <h3 className="font-semibold text-xl tracking-tight text-gray-600">
            {product.name} -{" "}
      ...
      <div className="flex p-5 items-center justify-center">
        ...
        <span className="text-2xl  mx-10 text-gray-600 font-bold">
          {quantity}
        </span>
        <button
